...
# the ID of the three inputs I got from the inspect code of the page
try:
    # Access the website
    ...
    #search_field = driver.find_element(By.ID, "pesquisa")  # Adjust the ID according to the actual field
    search_field = driver.find_element(By.CLASS_NAME, "barraPesquisaDOE")
    search_field.clear()
